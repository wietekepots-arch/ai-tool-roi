...
export const FINDINGS: Finding[] = [
  {
    ...
    verdict:
      "GPT 5.4 met high reasoning pakt grote contexten goed aan, de tone of voice zit goed en het voelt prettig in dagelijks deliverywerk. De combinatie van een 5-uursvenster en een weeklimiet is een betere match dan maandcaps.",
    judgmentDetail:
      "Na gebruik in fulltime deliverywerk is het beeld flink bijgesteld. GPT 5.4 met high reasoning overstijgt inmiddels Opus-niveau en pakt grote contexten beter aan dan eerder het geval was. De interactie voelt prettig — zowel in toon als in flow. Het capaciteitsmodel is ook gunstiger dan bij Cursor: de combinatie van een 5-uursvenster en een weeklimiet maakt pieken in gebruik beter beheersbaar. Als je tegen de korte limiet aanloopt, wacht je maximaal 5 uur in plaats van dat meteen de rest van de maand vastloopt; tegelijk voorkomt de weeklimiet dat je planning op previewruimte alleen gaat leunen. Dat maakt pieken in gebruik beheersbaar zonder dat de hele sprint eronder lijdt. De combinatie van Claude en Codex geeft bovendien de flexibiliteit om beide sterk concurrerende modellen te blijven inzetten. Het kan snel wisselen welk model in benchmarks met zijn nieuwste release beter scoort, en de verschillen kunnen significant zijn — door beide in de stack te houden voorkom je lock-in op het verkeerde moment. De huidige ruime preview-capaciteit voelt nog als bonus; gebruik die dus niet als vaste baseline voor planning.",
    recommendation:
